...
import { loginSchool } from "../../actions/SchoolAction";
                                    ...
                                    <div className="card-body">
                                        ...
                                        <form className="row g-3 needs-validation" onSubmit={checkLogin} method="POST" novalidate>
                                            ...
                                            <div className="col-12">
                                                <label for="yourSchoolemail" className="form-label">Email</label>
                                                <div className="input-group has-validation">
                                                    <span className="input-group-text" id="inputGroupPrepend">@</span>
                                                    <input type="email" value={schoolemail}
                                                        onChange={(e) => setSchoolEmail(e.target.value)} name="schoolemail" className="form-control" id="yourSchoolemail" required />
